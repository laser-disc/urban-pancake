  ...
  render() {
    return (
        <div className="header">
          ...
          <div className="col-xs-2"><Link to="/add"><img className="link-logo truck-logo" src="http://imgur.com/rKaONN6.png" alt="Truck"/><p className="home-text">Add a truck</p></Link></div>
